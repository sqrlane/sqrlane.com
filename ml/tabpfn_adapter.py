...
_ENABLE_MESSAGE = (
    ...
    "  4. use Python 3.12 or older for this backend (py -3.12 on Windows):\n"
    "     the 2.0.x pin wants an older scikit-learn, and on a newer Python\n"
    "     that has no prebuilt wheel, so pip tries to compile it and dies\n"
    "     looking for a C compiler.\n"
    "  5. on CPU with more than 1000 training rows, TabPFN refuses to run\n"
    "     unless TABPFN_ALLOW_CPU_LARGE_DATASET=1 is set - a speed guard,\n"
    "     not a fault; expect a long run.\n"
