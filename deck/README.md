...
```bash
cd deck
python3 build_slide_06.py          # writes slide-06-the-how-1.svg
python3 render.py slide-06-the-how-1.svg   # writes ...-preview.png at 2x
```
...
| `build_slide_01..07.py` | one per slide; all import `deckkit` |
...
| 04 The Job 1/2 | The status quo: 45 days, 26 handoffs, €127 a box |
| 05 The Job 2/2 | Half of sailings are late; who owns the cost, and why it matters |
| 06 The How 1/2 | Answers problem one: the desk work does itself |
| 07 The How 2/2 | Answers problem two: know early, while options still exist |
...
Slides 05 and 07 draw their maps from the product's own data, not by hand. The coastline is read at build time from
