#!/usr/bin/env python3
"""
Slide 07 - THE HOW (2/2).  Emits deck/slide-07-the-how-2.svg.
...
s.text(sx, TOP + 232, "60 live. Rest is phase two.", 10, 400, FAINT)
...
s.text(M, 890, "The prediction moves the decision left, into the window where options still exist.",
       23, 600, FG, ls=-0.5)
s.footer("07 / THE HOW 2/2")
s.write("slide-07-the-how-2.svg")
